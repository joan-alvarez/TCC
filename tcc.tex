...
\begin{figure}[htb]
  ...
  \includegraphics[width=3.5cm,trim = 50mm 0mm 50mm 0mm]{pararaio.pdf}
  \label{fig:pararaio}
  }
  \subfloat[Placa de identificação] {
  \includegraphics[width=11cm]{pararaio.jpg}
  }
...
\begin{figure}[htb]
  ...
  \includegraphics[width=9.3cm]{disjuntor.pdf}
  \label{fig:disjuntor}
  }
  \subfloat[Placa de identificação] {
  \includegraphics[width=6cm]{placadisjuntor.jpg}
  }
% \legend{Fonte: Do autor}
\end{figure}\par
...
\begin{figure}[htb]
  ...
  \subfloat {
  \includegraphics[width=8cm]{tcb.jpg}
  }
% \legend{Fonte: Do autor}
\end{figure}\par

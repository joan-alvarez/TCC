...
% ---------------------------------------------------
% Capítulo 2 (linguiça, quem sabe o principal)
% ---------------------------------------------------
...
\chapter{Especificação de equipamentos}
	...
	Este capítulo irá mostrar alguns equipamentos e sua devida especificação a partir de tabelas de seus manuais e os procedimentos descritos em \citeonline{book:EquiElet}, \citeonline{book:TransitElet} e \citeonline{book:equipAT}.\par

	\section{Corrente de Curto-Circuito}
